...
Classifier = 'SVM';
txt_path = '/raid5/DataCenter/Face/liveness/total/total_new.txt';
...
%
Faces_HSV(10000:2:end) = [];
labels1(10000:2:end) = [];
Faces_HSV(10000:3:end) = [];
labels1(10000:3:end) = [];
...
%
Faces_YCbCr(10000:2:end) = [];
labels2(10000:2:end) = [];
Faces_YCbCr(10000:3:end) = [];
labels2(10000:3:end) = [];
...
if strcmp(Classifier,'SVM')
     ...
     save('Model_1.mat','Model','Subspace','Bovw');
end
